const CollegeCards = () => {
  return (
    <div className='container grid grid-cols-3 p-4 mx-auto mt-32 md:grid-cols-1 md:p-0'>
      {/* <!-- Card wrapper --> */}
      <div className='flex flex-wrap w-full mx-auto border border-black shadow-lg lg:w-4/5'>
        {/* <!-- Card image --> */}
        <div
        ...
        <div className='w-full bg-white md:w-2/3'>
          ...
          <div className='relative h-full px-6 mx-auto md:px-0 md:pt-6 md:-ml-6'>
            ...
            <div className='grid grid-cols-1 mb-4 -mt-6 bg-white md:p-6 lg:h-full md:mt-0 md:mb-0 md:grid-cols-4 md:gap-6'>
              {/* <!-- Card title and subtitle --> */}
              <div className='w-full text-center lg:w-3/5 lg:border-right lg:border-solid md:text-left'>
                <h3>College Name</h3>
              ...
              <div className='grid w-full grid-cols-1 col-span-3 md:gap-3 md:grid-cols-2 lg:px-2'>
                <div className='col-span-1'>
                  ...
                  <ul className='ml-4 '>
                    <li className='px-1 transition-all rounded hover:bg-primary hover:text-white '>
              ...
              <div className='w-full col-span-4 mx-auto mt-6 text-center lg:w-3/5 lg:mt-0 lg:px-4 md:text-left'>
                <button className='w-full py-2 border border-solid btn-primary btn hover:bg-grey-darker hover:text-white border-grey lg:w-full'>
                  View Details
                </button>
              </div>
              {/* <!-- ./Call to action button --> */}
